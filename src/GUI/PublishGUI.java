...
public class PublishGUI extends javax.swing.JPanel {
    DefaultTableModel tableModel;
    PublishBUS publishBUS=new PublishBUS();
    private ArrayList<PublishDTO> publisharr;
    ...
    public PublishGUI() {
        ...
        jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                PublishDTO publishDTO=new PublishDTO(0,jTextField1.getText(),jTextField2.getText(),jTextField3.getText());
                if(publishBUS.insertPublish(publishDTO)>0)
                {
                    loadPublish();
                }
            }
        ...
        jButton2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(i>-1)
                {
                    ...
                    PublishDTO adto=new PublishDTO(vitri,jTextField1.getText(),jTextField2.getText(),jTextField3.getText());
                    int a=JOptionPane.showConfirmDialog(null, "bạn có muốn sửa","",JOptionPane.YES_NO_OPTION);
                    if(a==JOptionPane.YES_OPTION)
                    {
                        if(publishBUS.update(adto)>0)
                        {
                            loadPublish();
                        }
                    }
        ...
        jButton5.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    JOptionPane.showMessageDialog(null, "vui lòng nhập mã nhà xuất bản cần tìm kiếm");
                    return;
                }
                ...
                int publishid=Integer.parseInt(jTextField4.getText());
//                PublishDTO pu=publishBUS.gI().search(publishid);
                PublishDTO pu=publishBUS.search(publishid);
                if(pu != null)
                {
                    tableModel.setRowCount(0);
                    Vector vec=new Vector();
                    vec.add(pu.getPublishid());
                    vec.add(pu.getPublishname());
                    vec.add(pu.getAddress());
                    vec.add(pu.getPhone());
        ...
        jTable1.addMouseListener(new MouseListener(){
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(i>-1)
                {
                     ...
                     jTextField2.setText(tableModel.getValueAt(i, 2).toString());
    ...
    {
        publisharr=publishBUS.getAllPublish();
        tableModel.setRowCount(0);
        for(PublishDTO author: publisharr)
        {
            Vector vec=new Vector();
            vec.add(author.getPublishid());
            vec.add(author.getPublishname());
            vec.add(author.getAddress());
            vec.add(author.getPhone());
            tableModel.addRow(vec);
        }
    }
    // number
    ...
    private void initComponents() {
        ...
        jButton5.setText("Tìm Kiếm Nhà Xuất Bản");
