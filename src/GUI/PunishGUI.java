...
public class PunishGUI extends JFrame {
    private PunishBUS punishBUS = new PunishBUS();
    ...
    public PunishGUI() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                DTO.PunishDTO phat = new DTO.PunishDTO(0, mapm, lydo, tienphat);
                if (punishBUS.addPunish(phat) > 0) {
        ...
        textField.setText(BorrowGUI.id);
